...
function QuizPage() {
  ...
  if (APP_CONFIG.showExamFeedback) {
    return (
      <div className="mx-auto w-full max-w-3xl px-4 py-10 sm:py-12 animate-fade-up">
        <ExamFeedback
          theme={subject}
          headline={subject ? `Live exam feedback for ${subject.name}` : "Live exam feedback"}
  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-4 py-12 animate-fade-up">
      <div className="grid gap-6">
        ...
        {APP_CONFIG.showExamFeedback && (
          <ExamFeedback
            theme={subject}
            headline="How was the live exam?"
            subhead="Leave a short note and rate your experience."
          />
        )}
      </div>
    </div>
